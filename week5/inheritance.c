// This is a program that prints out the inheritance of someone up to 3 generations.
...
person *create_family(int generations)
{
    ...
    if (generations > 1)
    {
        ...
        child->alleles[0] = parent0->alleles[random_int()];
        child->alleles[1] = parent1->alleles[random_int()];
    }
